...
BOOL LogService::SendCmdToAccountConnection(INT32 nMsgID, UINT64 u64TargetID, UINT32 dwUserData, const google::protobuf::Message& pdata)
{
...
BOOL LogService::ConnectToAccountSvr()
{
